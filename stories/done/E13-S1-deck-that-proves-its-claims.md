...
## Outcome (2026-07-26)
Done. `presentation/slides-content.md` (paste-ready, 9 core + 6 appendix slides, speaker notes, visual placement) and `presentation/deck.html` published as an Artifact: https://claude.ai/code/artifact/db7ddb23-ec77-4d1f-9cdb-59a8e941cc7f
